...
meshfile = "/home/AD/bsu233/labscripts/poissonnernstplanck/contantSigma/onepore/onepore.xml"
mesh = Mesh(meshfile)
...
bc3 = DirichletBC(V.sub(0),0,subdomain,1) #----> Assign a 0 Ca2+ at the botton reservor
...
print "Average Flux of Ca2+ is: ",flux_top/area
print "Effective Diffusion constant is of Ca2+ is: ",Deff
